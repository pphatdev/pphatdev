...
def _build_followers_section(followers):
    ...
    for follower in followers:
        ...
        html_url = follower.get("html_url") or f"https://github.com/{login}"
        avatar_url = follower.get("avatar_url") or f"https://github.com/{login}.png"
        lines.append(
...
def get_recent_followers_activity():
    ...
    recent_followers = github_api.get_recent_followers(limit=10)
